    ...
    useEffect(() => {
        const fetchRooms = async () => {
          try {
            ...
            console.error('Odaları Getirirken Beklenmedik Bir Hata Oluştu:', error.message);
          }
        };
        ...
        const fetchRoomTypes = async () => {
          try {
            ...
            console.error('Oda Tiplerini Getirirken Beklenmedik Bir Hata Oluştu:', error.message);
          }
        };
